...
void terminateProcess(qint64 pid)
{
    ...
    // which is going to poll isProcessRunning() afterward anyway. Not
    // independently verified on real macOS hardware (see SPEC.md 8) --
    // mirrors Automation_linux.cpp's terminateProcess().
